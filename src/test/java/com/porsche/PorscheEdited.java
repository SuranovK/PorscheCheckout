...
public class PorscheEdited {
	public static void main(String[] args) throws InterruptedException {
		...
		isEqual(totalPrice,DelivaeryPrice,basePrice2);
		...
		String equipmentPrice = driver.findElement(By.xpath("//*[@id=\"s_price\"]/div[1]/div[2]/div[2]")).getText();
		isEqual(miamiBlueEPrice,equipmentPrice);
		totalPrice = driver.findElement(By.xpath("//*[@id=\"s_price\"]/div[1]/div[4]/div[2]")).getText();
		 ...
		 isEqual(totalPrice,basePrice2,equipmentPrice,deliveryFee);
		...
		isEqual(equipmentPrice,wheelPrice,miamiBlueEPrice);
		...
		equipmentPrice = driver.findElement(By.xpath("//*[@id=\"s_price\"]/div[1]/div[2]/div[2]")).getText();
		isEqual(equipmentPrice,seatPrice,wheelPrice,miamiBlueEPrice);
		totalPrice = driver.findElement(By.xpath("//*[@id=\"s_price\"]/div[1]/div[4]/div[2]")).getText();
		isEqual(totalPrice,deliveryFee,basePrice2,equipmentPrice);
		...
		equipmentPrice = driver.findElement(By.xpath("//*[@id=\"s_price\"]/div[1]/div[2]/div[2]")).getText();
		isEqual(equipmentPrice,seatPrice,wheelPrice,miamiBlueEPrice,interiorTrimPrice);
		totalPrice = driver.findElement(By.xpath("//*[@id=\"s_price\"]/div[1]/div[4]/div[2]")).getText();
		isEqual(totalPrice,deliveryFee,basePrice2,equipmentPrice);
		...
		equipmentPrice = driver.findElement(By.xpath("//*[@id=\"s_price\"]/div[1]/div[2]/div[2]")).getText();
		isEqual(equipmentPrice,seatPrice,wheelPrice,miamiBlueEPrice,interiorTrimPrice,brakes,speed);
		totalPrice = driver.findElement(By.xpath("//*[@id=\"s_price\"]/div[1]/div[4]/div[2]")).getText();
		isEqual(totalPrice,deliveryFee,basePrice2,equipmentPrice);
...
public static void isEqual(String s1, String...var) {
    s1=s1.replaceAll("[ From$,*]","");
    double d1=Double.parseDouble(s1);
    double sum=0;
    for(String each:var) {
